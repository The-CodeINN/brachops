...
export const createJobSchema = z.object({
  body: z.object({
    ...
    envVars: z.record(z.string(), z.string()).optional(), // Add optional() method
  }),
});
...
export const createScanJobSchema = z.object({
  body: z.object({
    ...
    buildPath: z
      ...
      .min(
        1,
        "A valid build path is required. Please provide a .NET (.csproj) or Node.js directory containing package.json file."
      ),
    projectType: z.enum(["DotNetCore", "NodeJs"]),
  }),
});
